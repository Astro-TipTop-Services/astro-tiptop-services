---
id: tuto_ast_select
title: TipTop Asterism Selection — Hands-on Tutorial (VS Code / Jupyter)
...
It’s meant as a practical guide: pick the parts you need—no need to follow every step end-to-end.
</p>
