...
🗂️ This page provides `.ini` configuration files tailored for various instruments: [ERIS](#eris), [HARMONI](#harmoni), [MAVIS](#mavis), [MICADO](#micado), [MORFEO](#morfeo), [MUSE](#muse), [SOUL](#soul), [SPHERE](#sphere).
